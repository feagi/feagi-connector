...
class FeagiInterface:
    ...
    async def connect_via_zmq(self, feagi_host_address: str, camera_resolution_xyc: (int, int, int), motor_cortical_areas: list = None, registration_port: int = 30001, sensory_port: int = 5558, heartbeat_interval: float = 5.0) -> dict:
        ...
        Args:
            ...
            motor_cortical_areas: List of motor cortical areas to register (e.g., ['omot00', 'ogaz00'])
        ...
        response = await self._transport.send_registration(feagi_host_address, camera_resolution_xyc, sensory_port, motor_cortical_areas)
        return response